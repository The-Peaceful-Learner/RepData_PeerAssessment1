...
```
    The mean and median of the total number of steps taken per day are `r format(round(Mean_Tot_Steps_perday, digits = 2),nsmall = 2)` and `r Median_Tot_Steps_perday` respectively.
...
2. Which 5-minute interval, on average across all the days in the dataset, contains the maximum number of steps?
    ...
    The 5-minute interval that, on average across all the days in the dataset, contains the maximum number of steps is: `r names(Avg_Steps_intervalwise[Avg_Steps_intervalwise==max(Avg_Steps_intervalwise)])`
...
```
    The total number of missing values in the dataset is: `r Tot_Missing_Values`
...
```
    The mean and median of the total number of steps taken per day are `r format(round(Mean_Tot_Steps_perday_NAs_filled, digits = 2),nsmall = 2)` and `r format(round(Median_Tot_Steps_perday_NAs_filled,digits = 2),nsmall = 2)` respectively.
